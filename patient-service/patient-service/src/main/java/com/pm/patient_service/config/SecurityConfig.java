...
import com.pm.patient_service.security.jwt.RoleJwtGrantedAuthoritiesConverter;
...
public class SecurityConfig {
    ...
    public Converter<Jwt, ? extends AbstractAuthenticationToken> jwtAuthenticationConverter() {
        ...
        jwtAuthenticationConverter.setJwtGrantedAuthoritiesConverter(new RoleJwtGrantedAuthoritiesConverter());
